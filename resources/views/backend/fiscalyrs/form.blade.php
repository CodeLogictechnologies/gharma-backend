    ...
    <div class="modal-body">
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                ...
                <input type="text" name="start_date" id="start_date_np" class="form-control"
                    placeholder="2079-04-01" autocomplete="off"
                    value="{{ $fiscalyear->start_date ?? '' }}" required readonly>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                ...
                <input type="text" name="end_date" id="end_date_np" class="form-control"
                    placeholder="2080-03-32" autocomplete="off"
                    value="{{ $fiscalyear->end_date ?? '' }}" required readonly>
            </div>
        </div>

        <div class="mb-3">
            <label class="form-label">Fiscal Year Code</label>
            <input type="text" id="code_preview" class="form-control" value="{{ $fiscalyear->code ?? '' }}" disabled placeholder="Auto-generated from dates">
        </div>
