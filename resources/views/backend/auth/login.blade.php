                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                <span class="app-brand-logo demo">
                                    <img class="" style="width: 200px;" src="logo.png" alt="logo">
                                </span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to CLTECH ERP</h4>
                        <p class="mb-4">Please sign-in to your account and start the adventure</p>

                        @include('layouts.include.alertMessage')

                        <form id="login-form" class="mb-3" action="{{ route('loginuser') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            <div class="mb-3">
...
@enderror
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100" type="button" id="signin-btn">Sign in</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        ...
        $('#signin-btn').click(function() {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                dataType: 'json', // ✅ auto-parses response, no manual JSON.parse needed
