...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('order_details', function (Blueprint $table) {
            ...
            $table->decimal('excise_percent', 15, 2)->nullable()->change();
            $table->decimal('vat_amount', 15, 2)->change();
            $table->decimal('vat_percent', 15, 2)->nullable()->change();
    ...
    public function down(): void
    {
        Schema::table('order_details', function (Blueprint $table) {
            ...
            $table->decimal('excise_percent', 10, 2)->nullable()->change();
            $table->decimal('vat_amount', 10, 2)->change();
            $table->decimal('vat_percent', 10, 2)->nullable()->change();
